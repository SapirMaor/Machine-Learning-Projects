The project aimed to develop an accurate regressor using a dataset divided into train, dev, and test sets.
...
Model Exploration
- Tried different regressors, justifying selections based on experimental results.
